...
import { Slider, SliderOnChangeEvent, Button, Content, ContentVariants } from '@patternfly/react-core';
...
export const SliderActions: React.FunctionComponent = () => {
  ...
  return (
    <>
      <Content component={ContentVariants.h3}>Slider value is: {value1}</Content>
      <Slider
        value={value1}
        onChange={onChange1}
        startActions={
