...
import { Slider, SliderOnChangeEvent, Content, ContentVariants } from '@patternfly/react-core';
...
export const SliderDiscrete: React.FunctionComponent = () => {
  ...
  return (
    <>
      <Content component={ContentVariants.h3}>Slider value is: {numValue.value1}</Content>
      <Slider
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {numValue.value2}</Content>
      <Content component={ContentVariants.small}>(min = 0, max = 200, step = 50) </Content>
      <Slider
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {Math.floor(numValue.value3)}</Content>
      <Content component={ContentVariants.small}>(min = -25, max = 75, step = 10, boundaries not shown) </Content>
      <Slider
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {Math.floor(numValue.value4)}</Content>
      <Content component={ContentVariants.small}>(min = -25, max = 75, step = 10, boundaries shown) </Content>
      <Slider
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {Math.floor(numValue.value5)}</Content>
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {Math.floor(numValue.value6)}</Content>
      <Content component={ContentVariants.small}>(max = 5, custom steps) </Content>
      <Slider
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {Math.floor(numValue.value7)}</Content>
      <Content component={ContentVariants.small}>(min = 12, max = 86, custom steps with non linear data) </Content>
      <Slider
