...
import { Checkbox, Slider, SliderOnChangeEvent, Content, ContentVariants } from '@patternfly/react-core';
...
export const SliderContinuous: React.FunctionComponent = () => {
  ...
  return (
    <>
      ...
      />
      <Content component={ContentVariants.h3}>Slider Value is: {value}</Content>
      <Slider
      ...
      />
      <br />
      <Content component={ContentVariants.h3}>Slider value is: {valueCustom}</Content>
      <Slider
