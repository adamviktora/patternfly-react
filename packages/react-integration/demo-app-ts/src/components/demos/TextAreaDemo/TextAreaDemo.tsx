  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        />
        <Content>Required text area</Content>
        <TextArea
          id="textarea2"
        ...
        />
        <Content>Resize text area horizontally </Content>
        <TextArea
          id="textarea3"
        ...
        />
        <Content>Resize text area vertically </Content>
        <TextArea
          id="textarea4"
        ...
        />
        <Content>Validated text area </Content>
        <TextArea
          id="textarea5"
        ...
        />
        <Content>Disabled text area </Content>
        ...
        <Content>Read only text area </Content>
