...
export class TextInputDemo extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Content>Simple Text Input Example</Content>
        ...
        />
        <Content>Text Input Truncated on Left Example</Content>
        <TextInput
        ...
        />
        <Content>Validated Text Input </Content>
        <TextInput
          id="text-validated"
        ...
        />
        <Content>Select Text Using Ref Example </Content>
        <TextInput
          id="text-using-ref"
          ref={this.ref}
